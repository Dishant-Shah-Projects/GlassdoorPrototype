        ...
        <nav>
          <div className="locked-home-lg-margins d-block pt-xsm px-std">
            <div className="row justify-content-between align-items-baseline">
              <div
                class="track-click locked-home-logo d-flex justify-content-start col-6 col-lg-auto order-lg-first"
                data-ga-lbl="Logo"
              >
                <svg
                  width="121"
              ...
              <div class="container-menu-mask d-lg-none"></div>
              <div class="d-flex justify-content-lg-end align-items-center order-lg-last">
                <div class="locked-home-sign-in">
                  <a
                    href="/profile/login_input.htm?userOriginHook=HEADER_SIGNIN_LINK"
                    class="track-click gd-btn-locked-transparent susiLink sign-in strong nowrap"
                    target="_top"
                    data-ga-lbl="Sign In"
                  >
                    {" "}
                ...
                <div class="locked-home-post-jobs strong d-none d-lg-block">
                  <a
                    href="/post-job"
                    class="track-click nowrap"
                    target="_top"
