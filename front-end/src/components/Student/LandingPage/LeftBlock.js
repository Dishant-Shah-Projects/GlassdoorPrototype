                ...
                <div class="d-none d-lg-block p-std">
                  <div class="d-flex flex-row container-fluid justify-content-between align-items-center">
                    <span class="SVGInline mb-xsm css-1k2lqp9">
                      <svg
                        class="SVGInline-svg mb-xsm-svg css-1k2lqp9-svg"
                    ...
                    <span
                      showbadge="false"
                      class="SVGInline align-self-start css-171gp5j evfqoqj3"
                    >
                      <svg
                        class="SVGInline-svg align-self-start-svg css-171gp5j-svg evfqoqj3-svg"
                        xmlns="http://www.w3.org/2000/svg"
                        width="36"
                        height="36"
                        viewBox="5 4 30 35"
                      >
                        <g fill="none" fill-rule="evenodd">
                          ...
                          <path
                            ...
                            class="prefix__lightning"
                          ></path>
                        </g>
                      </svg>
                    </span>
                  </div>
                  <h3 class="css-17vthrg evfqoqj1">Pranjay Sagar</h3>
                  <div class="d-flex align-items-center mt-xsm mb-xsm">
                    <span class="SVGInline css-25qyin css-170llpw mr-xsm">
                      <svg
                        class="SVGInline-svg css-25qyin-svg css-170llpw-svg mr-xsm-svg"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="css-56kyx5">San Jose,CA</div>
                  </div>
                </div>
              </div>
            </div>
