...
import { showApplicantsModal, hideApplicantsModal, updateApplicantsList } from '../../../constants/action-types';
        ...
        <div class="col-12 col-md-6 pr-md-xxl">
          <div class="d-none d-md-block">
            {this.props.applicantsModalStore.popSeen ? (
              <ApplicantsList toggle={this.closeApplicantsModal} fetchApplicants={(PageNo) =>
                this.fetchApplicants(PageNo)} />
            ) : (
              <div>
                          ...
                          >
                            ...
                            <div id="SerpFixedHeader" style={{ display: 'none' }}>
                              <div class="empWrapper ctasTest">
                                <div class="empInfo newDetails">
                                  <div class="title">
                                    {this.props.jobSelectStore.jobsInfo.Title}
                                  </div>
                                  <div class="location">
